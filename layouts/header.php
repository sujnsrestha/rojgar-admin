...
<head>
    ...
    <link href="<?=URL('public/admin/ckeditor/contents.css')?>" rel="stylesheet">
    <!-- bootstrap-datetimepicker -->
    <link href="<?=URL('public/admin/vendors/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css')?>" rel="stylesheet">

    <!-- Custom styling plus plugins -->
    <link href="<?=URL('public/admin/select2/dist/css/select2.css')?>" rel="stylesheet">

    <link href="<?=URL('public/admin/build/css/custom.min.css')?>" rel="stylesheet">
    <link href="<?=URL('public/admin/custom/custom.css')?>" rel="stylesheet">
</head>
